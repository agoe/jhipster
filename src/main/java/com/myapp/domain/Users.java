...
public class Users implements Serializable {
    ...
    public void setPosts(Set<Posts> posts) {
        if (this.posts != null) {
            this.posts.forEach(i -> i.setUsers(null));
        }
        if (posts != null) {
            posts.forEach(i -> i.setUsers(this));
        }
        this.posts = posts;
    }
    ...
    public Users addPosts(Posts posts) {
        this.posts.add(posts);
        posts.setUsers(this);
        return this;
    }

    public Users removePosts(Posts posts) {
